...
void ApplyDfishPatch(void)
{
    s_collectorwander1.shapenum = s_collectorfdoor1.shapenum = DOPE1;
    s_collectorwander1.tictime = s_collectorfdoor1.tictime = 2;
    s_collectorwander2.shapenum = s_collectorfdoor2.shapenum = DOPE2;
    s_collectorwander2.tictime = s_collectorfdoor2.tictime = 2;
    s_collectorwander3.shapenum = s_collectorfdoor3.shapenum = DOPE3;
    s_collectorwander3.tictime = s_collectorfdoor3.tictime = 2;
    s_collectorwander4.shapenum = s_collectorfdoor4.shapenum = DOPE4;
    s_collectorwander4.tictime = s_collectorfdoor4.tictime = 2;
    s_collectorwander5.shapenum = s_collectorfdoor5.shapenum = DOPE5;
    s_collectorwander5.tictime = s_collectorfdoor5.tictime = 2;
    s_collectorwander6.shapenum = s_collectorfdoor6.shapenum = DOPE6;
    s_collectorwander6.tictime = s_collectorfdoor6.tictime = 2;
    s_collectorwander7.shapenum = s_collectorfdoor7.shapenum = DOPE7;
    s_collectorwander7.tictime = s_collectorfdoor7.tictime = 2;
    s_collectorwander8.shapenum = s_collectorfdoor8.shapenum = DOPE8;
    s_collectorwander8.tictime = s_collectorfdoor8.tictime = 2;
