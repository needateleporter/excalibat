...
void SpawnMaskedWall (int tilex, int tiley, int which, int flags)
{
    ...
    {
        case mw_peephole:
            // Registered version was originally going to use
            // side: SIDE16, above: ABOVEM2A, middle: ABOVEM23A
        ...
        case mw_multi1:
            // Shareware version was originally going to use
            // above: ABOVEM4, middle: ABOVEM4A
        ...
        case mw_entrygate:
            // Registered version was originally going to use
            // side: SIDE20, above: ABOVEM7, middle: ABOVEM7A
            side = W_GetNumForName("SIDE21");
            above = W_GetNumForName("ABOVEM4");
            middle = W_GetNumForName("ABOVEM4A");
    ...
    if ((pw->tilex!=checkx) || (pw->tiley!=checky))
    {
                ...
                (pw->tiley==0) || (pw->tiley==127) )
        {
            if (W_CheckNumForName("imfree") >= 0)
            {
                ...
                VL_DecompressLBM(LBM, true, 239, 239, 239);
                VW_UpdateScreen();
                I_Delay(2000);
            }
